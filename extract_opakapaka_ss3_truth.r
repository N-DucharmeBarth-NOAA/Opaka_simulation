...
dir_ss3_em_no_platoon <- file.path(getwd(), "HRF_SQ_25_yrfwd","1","em_no_platoon")
...
em_no_platoon_results = r4ss::SS_output(dir_ss3_em_no_platoon, printstats = FALSE, verbose = FALSE)

opaka_truth = list(om = list(),em=list(), em_no_platoon = list())
opaka_truth$om$sprseries = om_results$sprseries[,c("Yr","SSB")]
opaka_truth$em$sprseries = em_results$sprseries[,c("Yr","SSB")]
opaka_truth$em_no_platoon$sprseries = em_no_platoon_results$sprseries[,c("Yr","SSB")]
...
opaka_truth$em_no_platoon$cpue = em_no_platoon_results$cpue[,c("Yr","Fleet","Fleet_name","Vuln_bio","Obs","Exp","SE")]
